...
function ProductDisplay() {
  ...
  const handleNotifySupplier = (productId, supplierId) => {
    ...
    axios.post('http://localhost:8070/notification', {
        product: productId,
        supplier: supplierId
    })
        .then(() => alert('Product notified to supplier'))
        .catch((err) => alert(get(err, 'response.data.msg', 'Notification failed')))
  };
              ...
              <td className="product-actions">
                ...
                <div className="action-buttons">
                  ...
                  <button
                    ...
                    onClick={() => handleNotifySupplier(product._id, get(product, 'supplier._id'))}
                  >
                    Notify
                  </button>
                  <button
